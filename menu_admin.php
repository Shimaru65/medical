                    ...
                    <ul class="nav navbar-nav">                  
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-puzzle-piece"></i><a href="main.php?page=home">เพิ่มบันทึกการตรวจสุขภาพ</a></li>
                                <li><i class="fa fa-id-badge"></i><a href="main.php?page=disease">เพิ่มรายการการตรวจสุขภาพ</a></li>
